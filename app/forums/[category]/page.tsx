...
const categoryFallbackPosts: Record<string, any[]> = {
  placements: [
    ...
    { id: 113, title: "Resume review thread for SDE roles", content: "Drop your anonymized resumes here. I'm a senior who recently bagged an offer from Microsoft. I will review as many as I can today.", author_name: "Arjun Kulkarni", created_at: new Date().toISOString(), likes: 512, views: 4500, replies: 5, tags: "resume, review, sde", category: "placements" }
  ],
  academics: [
    ...
    { id: 114, title: "Tips for scoring high in internal vivas?", content: "I always study well but freeze during viva voce when the external examiner cross questions. How do you maintain confidence?", author_name: "Sneha Iyer", created_at: new Date().toISOString(), likes: 45, views: 620, replies: 5, tags: "viva, exams, tips", category: "academics" }
  ],
  wellness: [
    ...
    { id: 115, title: "Feeling constantly burnt out.", content: "Does anyone else wake up feeling exhausted even after 8 hours of sleep? I feel like I'm running on empty every single day.", author_name: "Kavya Singh", created_at: new Date().toISOString(), likes: 230, views: 1200, replies: 5, tags: "burnout, sleep, health", category: "wellness" }
  ],
  hostel: [
    ...
    { id: 116, title: "Best midnight snacks for hostel?", content: "Getting bored of Maggi every night. What are some easy to make snacks that don't require a stove?", author_name: "Rahul Dravid", created_at: new Date().toISOString(), likes: 65, views: 340, replies: 5, tags: "food, snacks, midnight", category: "hostel" }
  ],
  coding: [
    ...
    { id: 117, title: "Anyone doing Web3 development?", content: "Is Web3 dead or is it still worth learning? I see fewer jobs for Solidity devs now compared to 2022.", author_name: "Omkar Naik", created_at: new Date().toISOString(), likes: 42, views: 890, replies: 5, tags: "web3, crypto, jobs", category: "coding" }
  ],
  "student-life": [
    ...
    { id: 118, title: "Join our music club jamming session!", content: "We're organizing an acoustic jamming session near the amphi this Friday at 6 PM. Bring your instruments! All are welcome.", author_name: "Diya Kapoor", created_at: new Date().toISOString(), likes: 120, views: 560, replies: 5, tags: "music, club, event", category: "student-life" }
  ],
  general: [
